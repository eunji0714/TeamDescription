    ...
    <div className='flex mt-8 pl-2'>
      ...
      <div className='flex flex-col my-auto ml-12'>
        ...
        <div className='flex items-center mt-4'>
          ...
          />
          <a
            href='https://github.com/maylh'
            className='mt-2 text-[13px] text-blue-800'
          >
            https://github.com/maylh
          </a>
        </div>
        <div className='flex items-center'>
          ...
          />
          <p className='mt-2 text-[13px] text-gray-800'>rrow2o@gachon.ac.kr</p>
        </div>
      </div>
    </div>
  )
